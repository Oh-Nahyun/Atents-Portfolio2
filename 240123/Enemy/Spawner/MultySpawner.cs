...
{
    // 인스펙터 창에서 멤버 변수인 구조체나 클래스 내부를 확인하고 싶으면 Serializable 속성을 추가해야 한다.
    [System.Serializable]
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Vector3 p2 = transform.position + Vector3.up * MaxY + Vector3.right * 0.5f;
        ...
        Vector3 p5 = asteroidDestination.position + Vector3.up * MinY + Vector3.right * 0.5f;
        Vector3 p6 = asteroidDestination.position + Vector3.up * MaxY + Vector3.right * 0.5f;
