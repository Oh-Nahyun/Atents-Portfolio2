...
public class AsteroidSpawner : EnemySpawner
{
    ...
    protected override void OnDrawGizmosSelected()
    {
        ...
        Vector3 p0 = destinationArea.position + Vector3.up * MaxY + Vector3.right * MinX;
        Vector3 p1 = destinationArea.position + Vector3.up * MinY + Vector3.right * MinX;
        Vector3 p2 = destinationArea.position + Vector3.up * MaxY + Vector3.right * MaxX;
        Vector3 p3 = destinationArea.position + Vector3.up * MinY + Vector3.right * MaxX;
